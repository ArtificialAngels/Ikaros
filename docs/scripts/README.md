...
| `core/env/init.bat` | `docs/scripts/core-env/init.md` |
| `core/memory_v5/cloud_chat 主链 (bin/cloud_chat.py)` | `docs/scripts/core-v5/cloud_chat.md` |
...
- [x] 批次4：core/env/*.bat/*.ps1（init / ikaros-env / init-ps1 / detect-root / validate-paths）
- [x] 批次5：core/memory_v5 根与 v5 核心（49 .py 模块 docstring + 内联段落抽取至 docs/scripts/core-v5/）
