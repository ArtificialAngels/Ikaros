...
>
> **2026-08-12 现状注记**：本文写于 52 个 `v5_*` 工具时代；当前工具面已收敛为 **48 个**（V5.3 activity/compression、V5.4 project、V5.5 skill 系列并入）。FTS5 tokenizer 崩溃问题已由 `search_like` 兜底修复（2026-08-10）。其余结论（双注入点、8 秒超时、人格不全机制）仍现行。
