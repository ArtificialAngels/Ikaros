...
// 合并自 ikaros-ct-settings: dsh 设置面板里的 CT 6 分区设置 + postMessage 桥接
import { apply as applyCtSettingsClient, inject as ctSettingsInject } from './settings/client'
...
/* ── 插件装配 ── */
const inject = ['slots', ...ctSettingsInject]
...
function apply(ctx: any) {
  ...
  // 合并: CT 设置面板 (dsh settings.section slot)
  applyCtSettingsClient(ctx)
}
