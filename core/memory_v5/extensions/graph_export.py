...
用法：
    python -m memory_v5.extensions.graph_export [--out PATH] [--min-weight N]
    # 默认输出 E:\\Ikaros\\core\\memory_v5\\data\\v5\\graphify-out\\graph.json
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="python -m memory_v5.extensions.graph_export",
