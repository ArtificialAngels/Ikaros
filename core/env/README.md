...
```bat
call "E:\Ikaros\core\env\ikaros-env.bat"
...
```powershell
. "E:\Ikaros\core\env\ikaros-env.ps1"
...
# 读取 JSON 配置
paths_json = Path(r"E:\Ikaros\core\env\ikaros-paths.json")
...
```bash
# 验证所有路径
python E:\Ikaros\core\env\scripts\validate-paths.py

# JSON 输出
python E:\Ikaros\core\env\scripts\validate-paths.py --json
```
