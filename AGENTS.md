...
This project is indexed by GitNexus as **hermes-agent-portable** (4401 symbols, 12769 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
