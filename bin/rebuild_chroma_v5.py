...
#
# 前置:
#   - embedding 服务 :8587 必须已起 (经控制面板 bin/ikaros-control.bat -> start 拉起,
...
MEMORY_ROOT = Path(os.environ.get("IKAROS_MEMORY", r"E:/Ikaros/Ikaros-memory")).resolve()
...
from v5 import search as vs  # noqa: E402
