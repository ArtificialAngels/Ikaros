...
rem 5. Reapply Ikaros patches BEFORE npm install (TypeScript needs them at build time)
echo [5/6] Reapply Ikaros patches >> "%LOG%"
...
rem 6. Install deps (TypeScript compile happens here, patches already applied)
