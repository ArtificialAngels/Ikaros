...
if not exist "%STUDIO%\packages\server\src\services\hermes\run-chat\types-v5.ts" "%PY%" -c "open(r'%STUDIO%\packages\server\src\services\hermes\run-chat\types-v5.ts','w').write('// V5 Agent types (generated by studio-local-update)\nexport interface V5AgentRunSocketData {\n  input: string | any[];\n  display_input?: string | any[] | null;\n  session_id?: string;\n  profile?: string;\n  provider?: string;\n  model?: string;\n  baseUrl?: string;\n  base_url?: string;\n  apiKey?: string;\n  api_key?: string;\n  coding_agent_id?: string;\n  agent_id?: string;\n}\n')"
