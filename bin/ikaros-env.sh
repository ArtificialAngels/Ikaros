...
export IKAROS_HERMES_AGENT="${IKAROS_ROOT}/core/hermes"
...
export IKAROS_NEKO_PYTHON="${IKAROS_ROOT}/core/neko/.venv/Scripts/python.exe"
export IKAROS_NEKO_SERVER="app.main_server"
export IKAROS_NEKO="${IKAROS_ROOT}/core/neko"
