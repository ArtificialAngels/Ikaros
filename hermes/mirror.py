r"""
Hermes Agent - Mirror / proxy configuration (inspired by ComfyUI-aki-v3).
...
Usage:
    from hermes.mirror import MirrorConfig, get_mirror
    cfg = MirrorConfig.from_yaml(hermes_config)
    hf_url = get_mirror("huggingface", "https://huggingface.co/Qwen/Qwen2.5-3B/resolve/main/ggml-model-q4_k_m.gguf")
