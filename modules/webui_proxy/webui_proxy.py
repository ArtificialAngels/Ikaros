...
# indicate "Ikaros is alive" — this is the bridge endpoint behind it.
...
WEBUI_TO_BRIDGE_PATH: dict[str, str] = {
    ...
    # Ikaros session recovery: SPA → /api/hermes/ikaros/* → bridge /v1/ikaros/*
    "/api/hermes/ikaros/last-session": "/v1/ikaros/last-session",
    "/api/hermes/ikaros/memories": "/v1/ikaros/memories",
    "/api/hermes/ikaros/awake-briefing": "/v1/ikaros/awake-briefing",
    "/api/hermes/ikaros/active-session": "/v1/ikaros/active-session",
}
...
# Ikaros session recovery: SPA-injected bridge UI.
...
ICARUS_RECOVERY_API_PREFIX = "/api/hermes/ikaros/"
...
class ProxyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        if self.path.startswith(USAGE_STATS_PATH):
            ...
            # WebUI can poll liveness to render an "Ikaros alive" badge.
            ...
            # /api/hermes/ikaros/* → bridge /v1/ikaros/* (mapped in WEBUI_TO_BRIDGE_PATHS)
            self._proxy_to_bridge()
        else:
            self._proxy_pass()
...
# ===================================================================
# Ikaros recovery injection (UI restart conversation continuity)
# ===================================================================
...
_INJECTION_SENTINEL = b"<!-- ikaros-recovery:v1 -->"
